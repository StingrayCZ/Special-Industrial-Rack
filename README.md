...
In my case I had to make a design of rack which is able to carry aluminium-sheets parts and subassemblies. Main problem were differencies among shapes of each object and also their non-compact shape which made it impossible for simply pallet-stacked. Second problem was that I had to use aleready bought a serial-produced rack. Last but not least, this rack was quite small for store all intended parts. Accoriding to this facts I have decided that I use any of the building kit system, specifically [Item 24](https://www.item24.com/). This solution has many advantages as whole variability for future changes and rebuilt. After finished the design I entrust tasks to order material
